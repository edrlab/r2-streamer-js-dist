...
var OPDS_AUTH_ENCRYPTION_KEY_BUFFER = crypto.pbkdf2Sync(uuid.v4(), salt, 1000, 32, "sha256");
var OPDS_AUTH_ENCRYPTION_KEY_HEX = OPDS_AUTH_ENCRYPTION_KEY_BUFFER.toString("hex");
var AES_BLOCK_SIZE = 16;
var OPDS_AUTH_ENCRYPTION_IV_BUFFER = Buffer.from(uuid.v4()).slice(0, AES_BLOCK_SIZE);
