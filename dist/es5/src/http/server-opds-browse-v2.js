                            ...
                            if (entry.Links && entry.Links.length) {
                                ...
                                entry.Links.forEach(function (link) {
                                    ...
                                    if (opds && link.Type &&
                                        ...
                                        var opdsUrl = req.originalUrl.substr(0, req.originalUrl.indexOf(exports.serverOPDS_browse_v2_PATH + "/"))
                                ...
                                if (epub_1) {
                                    ...
                                    var epubUrl = req.originalUrl.substr(0, req.originalUrl.indexOf(exports.serverOPDS_browse_v2_PATH + "/"))
