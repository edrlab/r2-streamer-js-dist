...
exports.serverOPDS_browse_v1_PATH = void 0;
...
function serverOPDS_browse_v1(_server, topRouter) {
    ...
    routerOPDS_browse_v1.get("/:" + request_ext_1._urlEncoded + "(*)", function (req, res) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var reqparams, urlDecoded, failure, success, headers;
        var _this = this;
        return tslib_1.__generator(this, function (_a) {
            ...
            success = function (response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                var responseData, err_1, responseStr, responseXml, isEntry, opds, opdsEntry, html, iconUrl, links;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
