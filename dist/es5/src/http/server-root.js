...
function serverRoot(server, topRouter) {
    ...
    topRouter.get("/", function (_req, res) {
        var html = "<!DOCTYPE html>\n<html>\n<body>\n<h1>Local Publications</h1>\n".concat(server.getPublications().map(function (pub) {
            var filePathBase64 = Buffer.from(pub).toString("base64");
            return "<h2><a href=\".".concat(server_pub_1.serverPub_PATH, "/").concat((0, UrlUtils_1.encodeURIComponent_RFC3986)(filePathBase64), "\">").concat((0, UrlUtils_1.isHTTP)(pub) ? pub : path.basename(pub), "</a></h2>\n");
        }).join("")).concat(server.disableOPDS ? "" : "<p>\n<a href='.".concat(server_opds_local_feed_1.serverOPDS_local_feed_PATH, "'>See OPDS2 Feed</a> (JSON)\n</p>\n"), "<h1>Additional Services</h1>\n\n<h2><a href='.").concat(server_version_1.serverVersion_PATH, "/").concat(request_ext_1._show, "'>Display Server Version</a></h2>\n\n").concat(server.disableRemotePubUrl ? "" : "<h2><a href='.".concat(server_url_1.serverRemotePub_PATH, "'>Load Remote Publication</a> (HTTP URL)</h2>\n<h2><a href='.").concat(server_lcp_lsd_show_1.serverLCPLSD_show_PATH, "'>Show LCP / LSD</a> (HTTP URL)</h2>\n"), "\n").concat(server.disableOPDS ? "" : "<h2><a href='.".concat(server_opds_browse_v1_1.serverOPDS_browse_v1_PATH, "'>Browse OPDS1 (XML/Atom) feed</a> (HTTP URL)</h2>\n<h2><a href='.").concat(server_opds_browse_v2_1.serverOPDS_browse_v2_PATH, "'>Browse OPDS2 (JSON) feed</a> (HTTP URL)</h2>\n<h2><a href='.").concat(server_opds_convert_v1_to_v2_1.serverOPDS_convert_v1_to_v2_PATH, "'>Convert OPDS v1 to v2</a> (HTTP URL)</h2>\n"), "\n</body>\n</html>\n");
