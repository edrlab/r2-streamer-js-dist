...
function serverOPDS_local_feed(server, topRouter) {
    ...
    routerOPDS_local_feed.get(["/", "/" + request_ext_1._show + "/:" + request_ext_1._jsonPath + "?"], function (req, res) {
        ...
        if (isShow) {
            ...
            var jsonObj = (0, serializable_1.TaJsonSerialize)(objToSerialize);
            ...
            if (doValidate) {
                ...
                var validationErrors = (0, json_schema_validate_1.jsonSchemaValidate)(jsonSchemasRootpath, jsonSchemasNames, jsonObj);
                if (validationErrors) {
                    validationStr = "";
            ...
            var publicationsJsonObj = (0, serializable_1.TaJsonSerialize)(feed);
