...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var publication, err_1, publication, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(ext === ".epub")) return [3, 5];
                publication = void 0;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, epub_1.EpubParsePromise(filePath)];
            case 2:
                publication = _a.sent();
                return [3, 4];
            case 3:
            ...
            case 4:
                ...
                return [3, 10];
            case 5:
                if (!(ext === ".cbz")) return [3, 10];
                publication = void 0;
                _a.label = 6;
            case 6:
                _a.trys.push([6, 8, , 9]);
                return [4, cbz_1.CbzParsePromise(filePath)];
            case 7:
                publication = _a.sent();
                return [3, 9];
            case 8:
