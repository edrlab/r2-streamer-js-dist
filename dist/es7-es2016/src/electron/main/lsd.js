...
function installLsdHandler(publicationsServer, deviceIDManager) {
    electron_1.ipcMain.on(events_1.R2_EVENT_LCP_LSD_RETURN, (event, publicationFilePath) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            renewResponseJson = yield lsd_return_1.lsdReturn(publication.LCP.LSDJson, deviceIDManager);
    ...
    electron_1.ipcMain.on(events_1.R2_EVENT_LCP_LSD_RENEW, (event, publicationFilePath, endDateStr) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        let renewResponseJson;
        try {
            renewResponseJson = yield lsd_renew_1.lsdRenew(endDate, publication.LCP.LSDJson, deviceIDManager);
            publication.LCP.LSDJson = renewResponseJson;
...
function launchStatusDocumentProcessing(publication, publicationPath, deviceIDManager, onStatusDocumentProcessingComplete) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const success = (response) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                licenseUpdateResponseJson = yield lsd_injectlcpl_1.lsdLcpUpdate(lsdJson, publication);
            }
            catch (err) {
                debug(err);
            }
            if (licenseUpdateResponseJson) {
                let res;
                try {
                    res = yield lsd_injectlcpl_1.lsdLcpUpdateInject(licenseUpdateResponseJson, publication, publicationPath);
            ...
            try {
                registerResponseJson = yield lsd_register_1.lsdRegister(lsdJson, deviceIDManager);
