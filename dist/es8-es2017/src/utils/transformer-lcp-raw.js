...
async function getDecryptedSizeStream(lcpContentKey, stream) {
...
class TransformerLCPRaw {
    ...
    async transformStream(publication, link, url, stream, isPartialByteRangeRequest, partialByteBegin, partialByteEnd, sessionInfo) {
