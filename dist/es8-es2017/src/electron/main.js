...
const main_browser_window_tracker_1 = require("./main_browser-window-tracker");
...
async function createElectronBrowserWindow(publicationFilePath, publicationUrl) {
    ...
    await lsd_1.launchStatusDocumentProcessing(publication, publicationFilePath, deviceIDManager, () => {
