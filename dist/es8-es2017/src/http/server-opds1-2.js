...
const converter_1 = require("r2-shared-js/dist/es8-es2017/src/opds/converter");
const opds_1 = require("r2-shared-js/dist/es8-es2017/src/opds/opds1/opds");
...
const xml_js_mapper_1 = require("r2-shared-js/dist/es8-es2017/src/_utils/xml-js-mapper");
...
`;
    ...
    routerOPDS12.get("/:urlEncoded(*)", async (req, res) => {
